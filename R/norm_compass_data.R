...
#'
#' A dataset containing normalized hospital means for 9 different variables. This dataset was used in 2016 annual report.
#' The dataset is the normalized version of compass_data, normalized with norm_compass(). Dataset is used for compass()
#' and compass_riket() examples.
#'
...
#'   \item{Pain reduction}{normalized pain reduction before operation and 1 year after, numeric}
